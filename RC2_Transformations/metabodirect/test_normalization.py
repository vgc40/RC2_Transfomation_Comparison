...
def get_args():
    ...
    input_dir = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'input_formated')
    default_data_file = os.path.join(input_dir, 'EC_sediment_metaboDirect_input.csv')
    default_metadata_file = os.path.join(input_dir, 'ICR_metadata.csv')
